...
export default function RefInput() {
     ...
     * 
     *      Controlled comopnents and elements are managed by react
     *          react decides what values they hold and when to hold them
     *          can use useState to turn an uncontrolled coponent into a controlled one
     * 
     */
    ...
    return (
        <>
            <div>
                ...
                <input id="uncontrolled-input" ref={inputRef} />     {/** ref is going to bind the inputRef to the value of this tag */}
