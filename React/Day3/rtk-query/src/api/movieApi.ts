...
export type Movie = {
    ...
    title : String,
    rating : number,
    director? : {               // ? means the property is optional for the type
        firstName? : String,
        lastName? : String
    }
}
 ...
 * 
 *      it takes in an object with 3 properties:
 *          - reducerPath - a path to be usd by your redux store as a reducer
 *          - baseQuery - the default url for your server
 *          - endpoints - a function that takes an object as a param where each property in that object is an endpoint
...
export const movieApi = createApi({
    ...
    endpoints : (builder) => ({
         ...
         *      the first is the type of the returned data
         *      the second is the tye of what data you're passing in to the function
         * 
